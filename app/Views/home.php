...
<body class="bg-gray-100">
    ...
    <div id="modalDelete" class="fixed inset-0 bg-opacity-40 hidden justify-center items-center z-50 backdrop-blur-sm">
        <div id="modalContent" class="bg-white p-6 rounded-xl shadow-lg max-w-md w-full">
            ...
            <h4 class="my-12 text-xl uppercase text-center text-red-500"> ¿Estas seguro de querer eliminar esta tarea? </h4>
            <div class="border-b-1 border-gray-200 mt-3"></div>
            <div class="mt-5 mb-2 flex justify-between items-center">
                ...
                <button
                    class="border border-red-500 px-5 py-2 rounded-lg uppercase hover:bg-red-500 hover:text-white cursor-pointer">
                        Eliminar
                </button>
            </div>
        </div>
